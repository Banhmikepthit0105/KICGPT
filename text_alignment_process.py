...
with open("dataset/" + args.dataset + "/alignment/alignment_output.txt", "r", encoding='utf-8') as f:
    lines = f.readlines()
    for line in lines:
...
with open("dataset/" + args.dataset + "/alignment/alignment_clean.txt", "w", encoding='utf-8') as f:
